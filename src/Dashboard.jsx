...
function Dashboard() {
    ...
    const changeNav = () => {
        if (stylenav === "sb-nav-fixed") {
            setStylenav("sb-nav-fixed sb-sidenav-toggled")
        } else {
            setStylenav("sb-nav-fixed")
        }
    }
  return (
    <div>
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            {/* <!-- Navbar Brand--> */}
            <a class="navbar-brand ps-3" href="index.html">INSPEKTORAT</a>
            {/* <!-- Sidebar Toggle--> */}
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!" onClick={changeNav}><i class="fas fa-bars"></i></button>
            {/* <!-- Navbar Search--> */}
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatablesSimple" className='datatable-table'>
                                    <thead>
                                        <tr>
                                        <th data-sortable="true" aria-sort={shortirtable} className={nametable}> 
                                        <a onClick={tablenameklik} href="#" class="datatable-sorter">Name</a>
                                            </th>
